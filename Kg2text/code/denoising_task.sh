FAIRSEQ=/home/xianjiay/efs-storage/fairseq
#CUDA_VISIBLE_DEVICES=0,1,2,3 python ${FAIRSEQ}/train.py
python ${FAIRSEQ}/train.py Kg2text/data-bin/webnlg/sentencepiece_bped_data --encoder-normalize-before --decoder-normalize-before --arch mbart_large --task  \
