CUDA=$1
BASE=/efs-storage
BASEDIR=/efs-storage/workspaces/hoverboard
FAIRSEQ=${BASEDIR}/fairseq/fairseq_cli
PRETRAIN=${BASE}/models/mbart50.ft.nn/model_wtags/model.pt
...
DATADIR=${BASE}/data-bin/${NAME}
SAVEDIR=${BASE}/checkpoint/mbart50_mbart50_finetun_webnlg_wtags
