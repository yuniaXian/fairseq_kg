...
# NAME=webnlg/data_mbart50_wtags
DATADIR=${EFS}/data-bin/dataset_kg2text/kgtext_wikidata
PRETRAIN=${EFS}/models/mbart50.ft.nn/model_wtags/model.pt
tensorboard_dir=${BASE}/logs/tensorboard/kg2text_kgtext_wikidata
checkpoint_dir=$BASE/checkpoints/kg2text_kgtext_wikidata
...
CUDA_VISIBLE_DEVICES=${CUDA} python ${FAIRSEQ}/train.py ${DATADIR} \
    ...
    --arch mbart_large --task translation --save-dir ${checkpoint_dir} \
