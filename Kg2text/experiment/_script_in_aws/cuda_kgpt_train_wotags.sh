...
SAVEDIR=${BASE}/checkpoints/kgpt_train_webnlg_wotags
tensorboard_dir=${BASE}/logs/tensorboard/kgpt_train_webnlg_wotags
...
CUDA_VISIBLE_DEVICES=${CUDA} python ${FAIRSEQ}/train.py ${DATADIR} \
    ...
    --arch transformer_kgpt_woemb --task translation --save-dir ${SAVEDIR} \
    ...
    --log-format simple --tensorboard-logdir ${tensorboard_dir}
