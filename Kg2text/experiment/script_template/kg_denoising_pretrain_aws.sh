...
tensorboard_dir=${EFS}/logs/tensorboard/denoising_kgtext_wikidata/$pretrain_setting
checkpoint_dir=${EFS}/checkpoints/denoising_kgtext_wikidata/$pretrain_setting
#restore_file=$checkpoint_dir/checkpoint3.pt
